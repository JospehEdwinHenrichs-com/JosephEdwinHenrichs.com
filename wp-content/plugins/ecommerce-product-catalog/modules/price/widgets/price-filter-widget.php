	...
	function widget( $args, $instance ) {
		if ( get_integration_type() != 'simple' ) {
			if ( ic_if_show_filter_widget( $instance ) ) {
				...
				?>
				<div class="price-filter ic_ajax <?php design_schemes( 'box' ) ?> <?php echo $class ?>" data-ic_ajax="price-filter" data-ic_responsive_label="<?php _e( 'Price', 'ecommerce-product-catalog' ) ?>">
