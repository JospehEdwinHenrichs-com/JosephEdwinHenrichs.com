...
namespace Tenweb_Manager {
    ...
    class MigrationConfig extends Migration
    {
        ...
        public function run()
        {
            ...
            $file_to_save_json = self::get_tmp_dir() . "/" . self::MIGRATION_CONFIG_FILE_NAME;
        ...
        private function get_site_info()
        {
            ...
            $config["wp_uploads_dir"] = str_replace(ABSPATH, '', Migration::get_uploads_dir());

            // set mysql version
            $sql_version = $this->wpdb->get_var("SELECT VERSION() AS version");
            $config["sql_version"] = $sql_version;
            $config["db_prefix"] = $this->wpdb->prefix;
