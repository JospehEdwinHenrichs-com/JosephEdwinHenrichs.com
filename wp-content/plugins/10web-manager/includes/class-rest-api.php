...
namespace Tenweb_Manager {
    ...
    class RestApi
    {
        ...
        public function update_item($request)
        {
            ...
            switch ($endpoint) {
                ...
                case 'templates':
                    ...
                    $response = $this->install_template($template_id, $template_url, $type, $action);
        ...
        private function create_migration_file($password, $iv)
        {
            ...
            Helper::store_migration_log('start_migrate_set_transient', 'start_migrate_set_transient.');
        ...
        public function install_template($template_id, $template_url, $type, $action)
        {
                ...
                if ($type === 'site') {
                    ...
                    switch ($action) {
                        ...
                        case 'import-attachments':
                            $result = $import->import_attachments($template_id);
                            break;
