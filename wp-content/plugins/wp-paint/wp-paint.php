...
// // Define Path.
define('WPP_PLUGIN_VERSION', '0.3.7');
define('WPP_PLUGIN_VERSION_HASH', '9c0cb5b805796fe5f719574862dbbe0ce29c169253ce5ef1');
...
if(!function_exists('wp_paint_activate')) {
  function wp_paint_activate() {
    ...
    update_option("wp_paint_activated_on", gmmktime());
  }
...
if(!function_exists('wp_paint_review_later')) {
  function wp_paint_review_later() {
    ...
    update_option("wp_paint_review_later_time", gmmktime() + round($days_to_remind_after * 24 * 3600));
  }
