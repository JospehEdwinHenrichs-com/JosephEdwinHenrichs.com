...
//code for google font title//
	...
	$(document).on( 'click', '.hero_description_gfont', function(){
	 ...
	 $(document).on( 'change', '.modal-content #hero_font_variant', function(){
		 ...
		 if($('#hero_font_variant').val()!==''){
			$("head").append("<link rel='stylesheet' href='http://fonts.googleapis.com/css?family="+fontname+":"+$('#hero_font_variant').val()+"' media='all'>");
			
		}else{
			$("head").append("<link rel='stylesheet' href='http://fonts.googleapis.com/css?family="+fontname+"' media='all'>");
		...
		if($('#hero_font_family').val()!==''){
			...
			$.post(
				...
				function(data){
					...
					if($('#hero_font_variant').val()!==''){
						$("head").append("<link rel='stylesheet' href='http://fonts.googleapis.com/css?family="+$('#hero_font_family').val()+":"+$('#hero_font_variant').val()+"' media='all'>");
					}else{
						$("head").append("<link rel='stylesheet' href='http://fonts.googleapis.com/css?family="+$('#hero_font_family').val()+"' media='all'>");
					}
	...
	$(document).on( 'change', '.modal-content #hero_intro_font_family', function(){
		if($('#hero_intro_font_family').val()!==''){
			...
			$("head").append("<link rel='stylesheet' href='http://fonts.googleapis.com/css?family="+$('#hero_intro_font_family').val()+"' media='all'>");
	...
	$(document).on( 'change', '.modal-content #hero_btn_font_family', function(){
		if($('#hero_btn_font_family').val()!==''){
			...
			$("head").append("<link rel='stylesheet' href='http://fonts.googleapis.com/css?family="+$('#hero_btn_font_family').val()+"' media='all'>");
