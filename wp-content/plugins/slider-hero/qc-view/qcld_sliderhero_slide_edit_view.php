    ...
    margin-left: 20px;padding: 10px 0px;">Auto:</span> <input class="myElements" name="style[fullwidth]" style="display: inline-block;width: 13px;height: 16px;margin: 0px;float: none;" type="radio" value="3" <?php 
							...
							<div class="othersetting">
								...
								<div class="params customitemstyle" >
									...
									<select name="params[repeat]">
										<option value="0" <?php echo (isset($params->repeat)and $params->repeat==0?'selected="selected"':''); ?>>Off</option>
										<option value="1" <?php echo (isset($params->repeat)and $params->repeat==1?'selected="selected"':''); ?>>On</option>
									</select>
								</div>
								<?php if($_slider[0]->type!='intro'): ?>
								<div style="clear:both"></div>
								...
								<div class="params deseffect customitemstyle">
									...
									<input class="myElements" style="width: 96%;" type="number" name="params[slideredirectdelay]"
											   value="<?php echo esc_attr($params->slideredirectdelay); ?>" placeholder="Ex: 1000" disabled />
						...
						<?php endif; ?>
							...
							<div class="params customitemstyle">
								...
								<!--<div class="params customitemstyle">
									<label class="customlevel" for="qchero-caption-text-color">Desctiption bg Color</label> <input type="text" name="params[descriptionbgcolor]" class="color-field myElements" value="<?php echo esc_attr($params->descriptionbgcolor); ?>" />
								</div>--> 
