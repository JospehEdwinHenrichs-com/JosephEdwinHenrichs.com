...
define( "QCLD_sliderhero_fonts", plugins_url( 'fonts', __FILE__ ), true );

define( "QCLD_sliderhero_asset", plugins_url( 'asset', __FILE__ ), true );
...
function qcld_sliderhero_admin_style_script($hook){
	...
	wp_enqueue_script( 'qcld_hero_slider_app_letter_fx_js', QCLD_sliderhero_js . "/jquery-letterfx.js", array('jquery'));
        ...
        wp_enqueue_script( 'slider_hero_custom-script-handle', QCLD_sliderhero_js . '/custom-script.js', array( 'wp-color-picker' ), null, true ); 
	...
	if ( ! $wpdb->get_var( "select count(*) from " . QCLD_TABLE_SLIDERS ) ) {
		$wpdb->insert(
			...
			array(
				'title'=>'First Slider',
				'type'=>'particle_snow',
				'params'=>'{"autoplay":1,"pauseonhover":1,"directionnav":1,"controlnav":1,"effect":{"interval":13000},"title":{"show":1,"align":"center","style":{"width":213,"height":61,"left":"0px","top":"10%"}},"button1":{"show":1,"position":"1","align":"center","style":{"width":213,"height":61,"left":"0%","top":"80%"}},"titleffect":"bounceInLeft","deseffect":"bounceInRight","description":{"show":1,"align":"center","style":{"width":213,"height":61,"left":"0%","top":"30%"}},"titlefontsize":50,"descfontsize":30,"background":"#4e56fc","titlecolor":"#ffffff","descriptioncolor":"#ffffff","paddingtime":500,"contentspace":"","titlebottommargin":"","descriptionbottommargin":"","buttonbottommargin":"","titlebgcolor":"","contentoffset":"","titlefontheight":"","descfontheight":"","bg_video_youtube":"","video_overlay_color":"","video_overlay_opacity":"","arrow":"arrow-circle","arrowcolor":"","arrowhovercolor":"","navigatorcolor":"","navigatorhovercolor":"","stopslide":0,"repeat":1,"randomslide":0,"content":"center","titleouteffect":"","descouteffect":"","hidearrow":0,"hidenavigation":0,"herorestart":0,"heropause":0,"video":"","video_loop":0,"video_mute":"","video_overlay":"","sound_control":1,"arrow_style":"default"}',
